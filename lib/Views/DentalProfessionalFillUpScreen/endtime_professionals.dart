...
class EndTimePickerProfessionalsScreen extends StatefulWidget {
  @override
  _EndTimePickerProfessionalsScreenState createState() =>
      _EndTimePickerProfessionalsScreenState();
}

class _EndTimePickerProfessionalsScreenState
    extends State<EndTimePickerProfessionalsScreen> {
  TimeOfDay get selectedTime {
    DateTime startDate =
        availabilityController.availability.value.endTime ?? DateTime.now();
  ...
  Future<void> _selectTime(BuildContext context) async {
    ...
    if (picked != null) {
      ...
      availabilityController.updateEndDate(endTime);
                ...
                Center(
                  child: NextContainer(
                    ...
                    onPressed: () {
                      ...
                      availabilityController.updateEndDate(endTime);
                      Get.toNamed(AppRoutes.professionalsWagesScreen);
                    },
                  ),
                ),
              ],
