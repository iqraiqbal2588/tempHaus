...
class StartTimePickerScreen extends StatefulWidget {
  @override
  _StartTimePickerScreenState createState() => _StartTimePickerScreenState();
}
...
class _StartTimePickerScreenState extends State<StartTimePickerScreen> {
  ...
  Future<void> _selectTime(BuildContext context) async {
    ...
    if (picked != null && picked != selectedTime) {
      ...
      officeController.updatePostingDetails(startTime: startDateTime);
    }
  }
              ...
              children: [
                ...
                Center(
                  child: NextContainer(
                    buttonText: 'Next',
                    onPressed: () {
                      // Add createdAt field when Next is pressed
                      final now = DateTime.now();
                      officeController.updatePostingDetails(createdAt: now);

                      Get.toNamed(AppRoutes.endTimePicker);
                    },
                  ),
                ),
              ],
